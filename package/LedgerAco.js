...
var LedgerAco = function(comm) {
	this.comm = comm;
	this.comm.setScrambleKey('w0w');
}

LedgerAco.prototype.getAddress_async = function(path) {
...
LedgerAco.prototype.signTransaction_async = function(path, rawTxHex) {
	var splitPath = utils.splitPath(path);
...
LedgerAco.prototype.getAppConfiguration_async = function() {
...
LedgerAco.prototype.signPersonalMessage_async = function(path, messageHex) {
	var splitPath = utils.splitPath(path);
	var offset = 0;
